  ...
  "node_modules/vscode-languageserver-types/lib/umd/main.js"(exports2, module2) {
    (function(factory) {
      ...
      (function(CodeLens2) {
        ...
        function is(value) {
          var candidate = value;
          return Is.defined(candidate) && Range3.is(candidate.range) && (Is.undefined(candidate.command) || Command2.is(candidate.command));
        }
        CodeLens2.is = is;
...
var unindexedProject = new lc.NotificationType("rust-analyzer/unindexedProject");
...
var Ctx = class {
  ...
  resolveBin() {
    ...
    let bin = (0, import_path3.join)(this.extCtx.storagePath, executableName);
